...
var WORLD_STATUS = "http://frontier.ffxiv.com/worldStatus/current_status.json",
    ...
    ARTICLE_INFO = "http://frontier.ffxiv.com/news/article.json?lang=";
...
var Frontier = {
  ...
  getArticle: function(lang, id, callback) {
    return createRequest(ARTICLE_INFO + lang + "&id=" + id, function(err, resp, body) {
      if(err !== null) {
        return callback(err, null);
      }

...
var WORLD_STATUS = "http://frontier.ffxiv.com/worldStatus/current_status.json",
    LOBBY_STATUS = "http://frontier.ffxiv.com/worldStatus/gate_status.json?lang=en-us",
    ...
    ARTICLE_INFO = "http://frontier.ffxiv.com/news/article.json?lang=en-us&id=";
...
var Frontier = {
  ...
  getLobbyStatus: function(callback) {
    return createRequest(LOBBY_STATUS, function(err, resp, body) {
      return callback(err, body);
    });
  },
  ...
  getHeadlines: function(callback) {
    return createRequest(HEADLINE_URL, function(err, resp, body) {
      if(err !== null) {
        return callback(err, null);
      }
